...
- ⬜ **Epic [#49](https://github.com/getpiper/piper/issues/49) remains open** — the rest of the remote control-plane track is not built: remote CLI target [#74](https://github.com/getpiper/piper/issues/74), health/metrics [#75](https://github.com/getpiper/piper/issues/75), hosted dashboard [#76](https://github.com/getpiper/piper/issues/76). The gate [#72](https://github.com/getpiper/piper/issues/72), the onboarding slice [#90](https://github.com/getpiper/piper/issues/90), and control-stream routing [#73](https://github.com/getpiper/piper/issues/73) are done.
