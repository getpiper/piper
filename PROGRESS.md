...
- ✅ **Public-relay onboarding slice (Plans 1–3)** — relay accounts + device-flow, `piper login`/`connect`, and relay-terminated shared domain; `login → connect → deploy → curl` e2e green — [#90](https://github.com/getpiper/piper/issues/90) (child of epic [#49](https://github.com/getpiper/piper/issues/49))
  ...
  - 🟡 **per-app BYO domains** — epic [#224](https://github.com/getpiper/piper/issues/224): remaining — per-domain lifecycle manager [#229](https://github.com/getpiper/piper/issues/229), domains API [#231](https://github.com/getpiper/piper/issues/231), `piper domains` CLI [#232](https://github.com/getpiper/piper/issues/232)
